...
**3. Настройте платформу.** Пропустить нельзя: токен на каждой платформе
...
**5. Убедитесь, что связка живая.** Повесьте на кнопку строку и нажмите:
...
Шаг 3 быстрого старта целиком. Обязателен: без него пакет стартует, сообщает,
