...
Десктоп и Аврора не поддерживаются, и в списке платформ пакета их нет:
нативного SDK для Flutter там нет, и ни одна сборка под них ни разу не
проверялась на живом проекте.
